          ...
          <div className="max-w-[1160px] mx-auto px-4 md:px-0 h-11 md:h-16 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link
                ...
                className="font-medium text-base text-[rgba(0,4,12,0.80)] hover:text-[#326CFF] transition-colors flex items-center gap-1"
              >
                Explorer
                <svg viewBox="64 64 896 896" className="w-3.5 h-3.5 -rotate-45" fill="currentColor">
          ...
          <div className="md:hidden bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-lg">
            <nav className="max-w-[1160px] mx-auto px-4 py-4 flex flex-col gap-4">
              ...
              <Link
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileMenuOpen(false)}
                className="font-medium text-base text-[rgba(0,4,12,0.80)] hover:text-[#326CFF] transition-colors py-2 flex items-center justify-between"
              >
                Explorer
                <svg viewBox="64 64 896 896" className="w-3.5 h-3.5 -rotate-45" fill="currentColor">
                  <path d="M869 487.8L491.2 159.9c-2.9-2.5-6.6-3.9-10.5-3.9h-88.5c-7.4 0-10.8 9.2-5.2 14l350.2 304H152c-4.4 0-8 3.6-8 8v60c0 4.4 3.6 8 8 8h585.1L386.9 854c-5.6 4.9-2.2 14 5.2 14h91.5c1.9 0 3.8-.7 5.2-2L869 536.2a32.07 32.07 0 000-48.4z"></path>
